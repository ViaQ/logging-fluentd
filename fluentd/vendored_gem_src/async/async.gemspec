...
Gem::Specification.new do |s|
  ...
  s.date = "2022-05-04"
  s.files = ["lib/async.rb".freeze, "lib/async/barrier.rb".freeze, "lib/async/clock.rb".freeze, "lib/async/condition.rb".freeze, "lib/async/debug/monitor.rb".freeze, "lib/async/debug/selector.rb".freeze, "lib/async/logger.rb".freeze, "lib/async/node.rb".freeze, "lib/async/notification.rb".freeze, "lib/async/queue.rb".freeze, "lib/async/reactor.rb".freeze, "lib/async/scheduler.rb".freeze, "lib/async/semaphore.rb".freeze, "lib/async/task.rb".freeze, "lib/async/variable.rb".freeze, "lib/async/version.rb".freeze, "lib/async/wrapper.rb".freeze, "lib/kernel/async.rb".freeze, "lib/kernel/sync.rb".freeze]
