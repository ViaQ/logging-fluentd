...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.md".freeze, "README.md".freeze, "lib/faraday/adapter/net_http.rb".freeze, "lib/faraday/net_http.rb".freeze, "lib/faraday/net_http/version.rb".freeze]
