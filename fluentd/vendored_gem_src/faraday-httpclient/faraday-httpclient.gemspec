...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.md".freeze, "README.md".freeze, "lib/faraday/adapter/httpclient.rb".freeze, "lib/faraday/httpclient.rb".freeze, "lib/faraday/httpclient/version.rb".freeze]
