...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.md".freeze, "LICENSE.md".freeze, "README.md".freeze, "lib/faraday/multipart.rb".freeze, "lib/faraday/multipart/file_part.rb".freeze, "lib/faraday/multipart/middleware.rb".freeze, "lib/faraday/multipart/param_part.rb".freeze, "lib/faraday/multipart/version.rb".freeze]
