# -*- encoding: utf-8 -*-
# stub: aws-sdk-cloudwatchlogs 1.60.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.md".freeze, "LICENSE.txt".freeze, "VERSION".freeze, "lib/aws-sdk-cloudwatchlogs.rb".freeze, "lib/aws-sdk-cloudwatchlogs/client.rb".freeze, "lib/aws-sdk-cloudwatchlogs/client_api.rb".freeze, "lib/aws-sdk-cloudwatchlogs/customizations.rb".freeze, "lib/aws-sdk-cloudwatchlogs/endpoint_parameters.rb".freeze, "lib/aws-sdk-cloudwatchlogs/endpoint_provider.rb".freeze, "lib/aws-sdk-cloudwatchlogs/endpoints.rb".freeze, "lib/aws-sdk-cloudwatchlogs/errors.rb".freeze, "lib/aws-sdk-cloudwatchlogs/plugins/endpoints.rb".freeze, "lib/aws-sdk-cloudwatchlogs/resource.rb".freeze, "lib/aws-sdk-cloudwatchlogs/types.rb".freeze]
