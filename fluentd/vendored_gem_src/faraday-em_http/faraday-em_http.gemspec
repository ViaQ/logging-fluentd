...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.md".freeze, "README.md".freeze, "lib/faraday/adapter/em_http.rb".freeze, "lib/faraday/adapter/em_http_ssl_patch.rb".freeze, "lib/faraday/em_http.rb".freeze, "lib/faraday/em_http/version.rb".freeze]
