...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.md".freeze, "README.md".freeze, "lib/faraday/adapter/em_synchrony.rb".freeze, "lib/faraday/adapter/em_synchrony/parallel_manager.rb".freeze, "lib/faraday/em_synchrony.rb".freeze, "lib/faraday/em_synchrony/version.rb".freeze]
