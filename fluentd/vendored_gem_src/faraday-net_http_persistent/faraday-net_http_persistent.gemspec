...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.md".freeze, "README.md".freeze, "lib/faraday/adapter/net_http_persistent.rb".freeze, "lib/faraday/net_http_persistent.rb".freeze, "lib/faraday/net_http_persistent/version.rb".freeze]
