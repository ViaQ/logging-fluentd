# -*- encoding: utf-8 -*-
# stub: aws-partitions 1.692.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.md".freeze, "LICENSE.txt".freeze, "VERSION".freeze, "lib/aws-partitions.rb".freeze, "lib/aws-partitions/endpoint_provider.rb".freeze, "lib/aws-partitions/partition.rb".freeze, "lib/aws-partitions/partition_list.rb".freeze, "lib/aws-partitions/region.rb".freeze, "lib/aws-partitions/service.rb".freeze, "partitions-metadata.json".freeze, "partitions.json".freeze]
